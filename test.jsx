...
ReactDOM.render( <Router
					...
					<Route
						...
						<Route
							path="test-button-purpose"
							component={ TestButtonPurpose }>
						</Route>

						<Route
							path="test-control-status"
							component={ TestControlStatus }>
						</Route>

						<Route
							path="test-control-purpose"
							component={ TestControlPurpose }>
						</Route>

						<Route
							path="test-header-status"
							component={ TestHeaderStatus }>
						</Route>

						<Route
							path="test-header-purpose"
							component={ TestHeaderPurpose }>
						</Route>

						<Route
							path="test-plate-status"
							component={ TestPlateStatus }>
						</Route>

						<Route
							path="test-plate-purpose"
							component={ TestPlatePurpose }>
						</Route>
						...
						<Route
							path="test-range-input"
							component={ TestRangeInput }>
						</Route>

						<Route
							path="test-note-input"
							component={ TestNoteInput }>
						</Route>

						<Route
							path="test-text-input"
							component={ TestTextInput }>
						</Route>

						<Route
							path="test-list-input"
							component={ TestTextInput }>
						</Route>

						<Route
							path="test-toggle-input"
							component={ TestToggleInput }>
						</Route>
